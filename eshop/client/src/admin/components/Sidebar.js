            ...
            <div className="left_sidebar">
                <nav className="sidebar">
                    ...
                    <ul id="main-menu" className="metismenu">
                        ...
                        <li>
                            <a href="#" className="has-arrow" onClick={() => toggle('products')}
                            ><i className="ti-pencil-alt"></i><span>Products</span></a>
                            <Collapse isOpen={productIsOpen ? true : childMenuRef.current}>
                                <ul>
                                    <li><NavLink to="/admin-dashboard/all-products"
                                                 onClick={() => childIsOpen('productsc')}
                                                 className={({isActive}) => (isActive ? 'active' : null)}>
                                        All Products
                                    </NavLink></li>
                                </ul>
